...
{
    public partial class EmployeeMod15
    {
        public EmployeeMod15()
        {
            AssignmentsMod15s = new HashSet<AssignmentsMod15>();
        }
        ...
        public virtual ICollection<AssignmentsMod15> AssignmentsMod15s { get; set; }
    }
}
