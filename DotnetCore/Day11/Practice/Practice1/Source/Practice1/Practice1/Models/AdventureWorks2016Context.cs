...
namespace Practice1.Models
{
    public partial class AdventureWorks2016Context : DbContext
    {
        ...
        public virtual DbSet<EmployeeBatch> EmployeeBatches { get; set; }
        public virtual DbSet<EmployeeDepartmentHistory> EmployeeDepartmentHistories { get; set; }
        public virtual DbSet<EmployeePayHistory> EmployeePayHistories { get; set; }
        public virtual DbSet<ErrorLog> ErrorLogs { get; set; }
        public virtual DbSet<External1> External1s { get; set; }
        ...
        public virtual DbSet<PlanetId> PlanetIds { get; set; }
        ...
        public virtual DbSet<Q001> Q001s { get; set; }
        ...
        public virtual DbSet<Testthrow> Testthrows { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(ConfigurationManager.ConnectionStrings["Jeet"].ConnectionString);
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>(entity =>
            {
                entity.HasKey(e => e.AccountNumber)
                    .HasName("PK__ACCOUNT__BE2ACD6ED97B3BF0");
                ...
                entity.HasOne(d => d.AccountTypeNavigation)
                    ...
                    .HasConstraintName("FK__ACCOUNT__Account__695C9DA1");
            });
            ...
            modelBuilder.Entity<Department>(entity =>
            {
                ...
                entity.HasIndex(e => e.GroupName, "nonClustured");
            ...
            modelBuilder.Entity<Employee3>(entity =>
            {
                entity.HasKey(e => e.Empid)
                    .HasName("PK__employee__AF4CE8653F29BFE7");
            ...
            modelBuilder.Entity<EmployeeBatch>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("EMPLOYEE_BATCH");

                entity.Property(e => e.Banking)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.Insuarance)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.Servicess)
                    .HasMaxLength(50)
                    .IsUnicode(false);
            });
            ...
            modelBuilder.Entity<External1>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("EXTERNAL1");
            ...
            modelBuilder.Entity<PlanetId>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("planetID");

                entity.HasIndex(e => e.Id, "onid")
                    .IsClustered();
            ...
            modelBuilder.Entity<Q001>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<Testthrow>(entity =>
            {
                entity.ToTable("TESTTHROW");
            ...
            modelBuilder.Entity<Transection>(entity =>
            {
                ...
                entity.HasOne(d => d.CreditAccountNavigation)
                    .WithMany(p => p.TransectionCreditAccountNavigations)
                    .HasForeignKey(d => d.CreditAccount)
                    .HasConstraintName("FK__Transecti__Credi__6E2152BE");

                entity.HasOne(d => d.DebitAccountNavigation)
                    .WithMany(p => p.TransectionDebitAccountNavigations)
                    .HasForeignKey(d => d.DebitAccount)
                    .HasConstraintName("FK__Transecti__Debit__6D2D2E85");
            });
